...
export default function page() {
  return (
    <div>
      ...
      <div className=' justify-center  ml-96 items-center mt-6'>
        <Image className='w-[90%] h-[30%]' src="/media/BR.jpg" width="400" height="200"/>
      </div>
      ...
      <div>
        ...
        <div className=' grid grid-cols-3 gap-5 border-t-2 border-b-2 mb-10 mr-12 ml-12 mt-9'>
          ...
          <div className=' col-start-2 pt-5 pl-5 border-l-2 border-r-2'>
